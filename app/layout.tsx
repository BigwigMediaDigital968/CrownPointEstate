  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            ...
            })(window,document,'script','dataLayer','GTM-NNTW5NLN');`,
          }}
        />
      ...
      >
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NNTW5NLN"
            height="0"
            width="0"
            style={{ display: "none", visibility: "hidden" }}
          />
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=942585585135216&ev=PageView&noscript=1"
          />
        </noscript>
