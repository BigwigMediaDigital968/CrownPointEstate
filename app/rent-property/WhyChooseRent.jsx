...
export default function WhyChooseSectionRent() {
  return (
    <>
      <section
        ...
        <div className="w-11/12 md:w-5/6 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-white leading-tight mb-5">
              Why Choose Crownpoint Estates for Rental Properties?
            </h2>
            <p className="text-white/70 text-[15px] leading-relaxed mb-6">
              ...
              helps you find the best property for rent in Gurgaon with verified
              listings and strong local expertise in Gurugram. We understand
              your requirements and provide suitable options that match your
          ...
          <div className="space-y-4">
            {[
              ...
              "Quick property shortlisting",
              "Professional and transparent support",
            ].map((item, i) => (
              <div
                key={i}
